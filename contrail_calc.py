...
def calculate_min_contrail_heights_hb(data_file):
	...
	#Jim Means formula - high bypass
	x = -91.60 + (4.674*np.log(press)) + (0.4564*np.log(press))**2
	y = (0.09036*rh) - (0.001985*rh)**2 + (0.00001967*rh)**3
...
def calculate_min_contrail_heights_lb(data_file):
	...
	#Jim Means formula - low bypass
	x = -92.43 + (4.646*np.log(press)) + (0.4465*np.log(press))**2
	y = (0.08902*rh) - (0.001955*rh)**2 + (0.00001938*rh)**3
